...
class principiaGrammar(Grammar):
    ...
    formula2 = Forward()
    formula3 = Forward()
    source_hash__ = "6e16a4e548e50993f3570a6a00d8ce91"
    ...
    _reverse_logical_sign = RegExp('[⊢∨⊃∼~≡=]|-[|]|>-|<->')
    _logical_sign = RegExp('[⊢∨⊃∼~≡=]|[|]-|->|<->')
    _rB = Drop(Text(")"))
    _lB = Drop(Text("("))
    _a4 = Text("::")
    _a3 = Alternative(Text(".:"), Text(":."))
    _a2 = Text(":")
    _a1 = Text(".")
    ...
    _d4 = Alternative(Series(Text("::"), Lookahead(_logical_sign)), Series(Lookbehind(_reverse_logical_sign), Text("::")))
    _d3 = Alternative(Series(Alternative(Text(":."), Text(".:")), Lookahead(_logical_sign)), Series(Lookbehind(_reverse_logical_sign), Alternative(Text(":."), Text(".:"))))
    _d2 = Alternative(Series(Text(":"), Lookahead(_logical_sign)), Series(Lookbehind(_reverse_logical_sign), Text(":")))
    _d1 = Alternative(Series(Text("."), Lookahead(_logical_sign)), Series(Lookbehind(_reverse_logical_sign), Text(".")))
    ...
    formula4 = Alternative(Series(and4, _d4, operator, Alternative(Series(_d4, and4), Series(_d3, and3), Series(_d2, and2), Series(_d1, and1), formula0, _element)), Series(Alternative(Series(and4, _d4), Series(and3, _d3), Series(and2, _d2), Series(and1, _d1), formula0, _element), operator, _d4, and4))
    statement = Series(numbering, _assertion)
    _element.set(Alternative(Not, _affirmation))
    formula0.set(Alternative(Series(_element, operator, _element), _element))
    formula1.set(Alternative(Series(and1, _d1, operator, Alternative(Series(_d1, and1), formula0, _element)), Series(Alternative(Series(and1, _d1), formula0, _element), operator, _d1, and1)))
    formula2.set(Alternative(Series(and2, _d2, operator, Alternative(Series(_d2, and2), Series(_d1, and1), formula0, _element)), Series(Alternative(Series(and2, _d2), Series(and1, _d1), formula0, _element), operator, _d2, and2)))
    formula3.set(Alternative(Series(and3, _d3, operator, Alternative(Series(_d3, and3), Series(_d2, and2), Series(_d1, and1), formula0, _element)), Series(Alternative(Series(and3, _d3), Series(and2, _d2), Series(and1, _d1), formula0, _element), operator, _d3, and3)))
